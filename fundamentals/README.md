...
1. [Intro to Whiteboarding](https://github.com/joinpursuit/DSA-Curriculum/tree/master/intro_to_whiteboarding)
1. [Control Flow](./control-flow/README.md)
1. [Terminal and Github](./terminal-github/README.md)
1. [Loops](./loops/README.md)
1. [Strings](./strings/README.md)
1. [Environment and Tools](./env-and-tools/README.md)
1. [Logic Problems](https://github.com/joinpursuit/DSA-Curriculum/tree/master/logic_problems)
1. [Arrays One](./arrays/README.md)
...
1. [Strings Lesson 1](./lecture-playgrounds/LecturePlayground71.playground)
  * [Strings Lesson 1 Video](https://youtu.be/a_3LjODW3t8)
